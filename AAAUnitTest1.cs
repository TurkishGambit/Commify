		...
		public void NPowerTest(IWebDriver browser)
		{
			...
			*/
			if (webDriver.Url.Contains("completed"))
			{
				...
				SQL.Queries.TblSoap_DeleteRow(1183, "976156be-28fc-45ef-81dd-06fab93c6010");
				webDriver.Navigate().GoToUrl("https://npower.mysecurepay-staging.co.uk/SessionId?=976156be-28fc-45ef-81dd-06fab93c6010");
			}
			String lookUpWeb = SQL.Queries.TblSOAP_GetLookUpWeb_Status(1183, "976156be-28fc-45ef-81dd-06fab93c6010");
			if (lookUpWeb.Equals("FAILED"))
			{
				Assert.Fail("LOOKUP is tblSOAP failed");
			}
			else
			{
			...
			*/
			...
			var statustblPayment = SQL.Queries.TblPayments_GetStatus(1183, "976156be-28fc-45ef-81dd-06fab93c6010");
